  ...
  return (
    <section className="my-10">
      ...
      >
        ...
        font-bold mb-10"
        >
          Hello <span className="text-orange-900">Welcome</span> Back
        </h3>
        <form action="" onSubmit={submitHandler}>
          <div className="mb-5">
            <input
              ...
              focus:outline-none focus:border-b-slate text-base
              leading-7 text-headingColor placeholder:text-textColor
              rounded-md cursor-pointer bg-orange-50"
          ...
          <p className="mt-5 text-textColor text-center">
            ...
            <Link to="/register" className="text-orange-950 font-medium ml-1">
              Register
            </Link>
          </p>
        </form>
