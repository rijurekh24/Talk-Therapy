            ...
            <div className="flex items-center justify-center">
              <figure
                className="w-[100px] h-[100px] rounded-full
                    border-2 border-solid border-orange-950"
              >
                <img
                  src={userData.photo}
                  alt=""
          ...
          <div className="md:col-span-2 md:px-[30px]">
            <div>
              <button
                ...
                className={` ${
                  tab === "bookings" && "bg-orange-950 text-white font-normal"
              ...
              <button
                ...
                className={` ${
                  tab === "settings" && "bg-orange-950 text-white font-normal"
                } py-2 px-5 rounded-md text-headingColor
                    font-semibold text-base leading-7 border border-solid border-orange-950`}
              >
                Profile Settings
              </button>
            </div>
